...
| 05/10/2023 | Trees: representation, traversals, and Binary Search Tree. Two pointers trick| [CCLR] Chapters 10.4 and 12 | [**Longest k-Good Segment**](https://codeforces.com/contest/616/problem/D?locale=en) and [**Frogs and Mosquitoes**](https://codeforces.com/contest/609/problem/F?locale=en) |
| 09/10/2023 | Sweep Line Algorithm | [Rossano's notes*](/rossano/blog/2023/sweepline) | [**Check if All the Integers in a Range Are Covered**](https://leetcode.com/problems/check-if-all-the-integers-in-a-range-are-covered/) and  [Cow Steeplechase II](http://www.usaco.org/index.php?page=viewproblem2&cpid=943)|
...
| Date | Lecture | References | Problems |
| ------------- | ------------- | ------------- | ------------- |
| 2021 | Prefix sum: Binary Indexed Tree (aka BIT or Fenwick tree) | BIT: [description](https://en.wikipedia.org/wiki/Fenwick_tree), [tutorial](https://www.topcoder.com/community/data-science/data-science-tutorials/binary-indexed-trees/#add), [video](https://www.youtube.com/watch?v=CWDQJGaN1gY), [visualgo](https://visualgo.net/fenwicktree), and [code](/code/fenwick_tree.hpp).| [Update the array](http://www.spoj.com/problems/UPDATEIT/) |
| 2021 | Applications of BIT and Range update with BIT. | [Range updates on BIT](http://petr-mitrichev.blogspot.com/2013/05/fenwick-tree-range-updates.html). [Tutorial](https://cp-algorithms.com/data_structures/fenwick.html). [RMQ with BIT](http://ioinformatics.org/oi/pdf/v9_2015_39_44.pdf) (optional)  | [Nested segments](http://codeforces.com/problemset/problem/652/D?locale=en) and [Pashmak and Parmida's problem](http://codeforces.com/problemset/problem/459/D?locale=en) |
