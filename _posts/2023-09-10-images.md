...
It's worth noting that within this approach, there are a total of $$n$$
insertions and at most $$n$$ extractions of the maximum in the heap. Since the maximum number of elements 
present in the heap at any given time contains up to $$n$$, each of these operations takes $$\Theta(\log n)$$ 
