...
Guess what? A solution to this problem binary searches for the answer, the target distance $$d$$.
...
Thus, the feasibility is a monotone boolean predicate that we can use to binary search for the answer.
