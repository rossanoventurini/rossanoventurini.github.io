...
<br>
##### Nested Segments
This problem is from [CodeForces](http://codeforces.com/problemset/problem/652/D?locale=en).
...
This problem can be solved by employing the [sweep line algorithm](/rossano/blog/2023/sweepline/) and a Fenwick tree. First, we build the Fenwick tree by adding $$1$$ in each position that correspons to right endpoint of a segment. This way, a `sum(r)` reports the number of segments that end in the range $$[1,r]$$.
...
<br>
##### Update the Array
This [problem](http://www.spoj.com/problems/UPDATEIT/) is from SPOJ.
