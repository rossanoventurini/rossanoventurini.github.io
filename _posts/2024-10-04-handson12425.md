...
description: First hands-on for the course Competitive Programming and Contests at University of Pisa
...
<br>
#### Submission
Submit a file ```lib.rs``` and a file ```Handson_1_solution_YOUR_NAME.pdf``` to [rossano.venturini@gmail.com](mailto:rossano.venturini@gmail.com). 
