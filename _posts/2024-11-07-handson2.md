...
layout: post
title: HandsOn 2
date: 2024-11-07 7:01:00
description: Second hands-on for the course Competitive Programming and Contests at University of Pisa
...
This is the text of second hands-on of the the course [*Competitive Programming and Contests*](competitive/) at University of Pisa.
...
[Here](/rossano/assets/zip/Testset_handson2_p1.zip) we have a set of tests with the following format.
...
[Here](/rossano/assets/zip/Testset_handson2_p2.zip) we have a set of tests with the following format.
...
<br>
#### Submission
Submit the files  `main.rs` and `lib.rs` and a file `Handson_2_solution_YOUR_NAME.pdf` to [rossano.venturini@gmail.com](mailto:rossano.venturini@gmail.com).
